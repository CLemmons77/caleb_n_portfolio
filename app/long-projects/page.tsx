...
export default function longProjects() {
  return (
    <section>
      <h1 className="mb-8 text-2xl border-2 p-1 text-center rounded-md font-medium tracking-tight invert bg-white dark:bg-black cursor-default">Long-form Video Projects</h1>
